 ...
 *     好きな場所で音を鳴らせてしまう。弾倉は嘘をつくための道具なので、
 *     嘘のつき方こそ地形に縛られていてほしい。
 ...
 *
 * --- 見え方 ---
 * 飛んでいる姿は投げた本人にしか見えない。軌跡が見えると、音で釣るはずが
 * 「そこから投げた奴が居る」という手掛かりになって逆効果になる。
 * 落ちて止まった物は全員に見える。確かめに行けば弾倉だと分かる、という手を残す。
 */
...
export class ThrownItems {
  ...
  private advance(
     ...
     * 水面。**跳ねずに沈む。**
     *
     * 手榴弾と同じ (sim/judge/ballistic.ts の stepProjectile)。弾倉はそちらと別の
   ...
   * 床に聞こえる**。弾倉は音でおびき寄せる物なので、鳴る場所が嘘になるのは困る。
   */
