 ...
 * 登り降りの速さ (m/s)。**歩くより遅い。**
 *
 * 2.2 は速すぎた (走るのと変わらない)。梯子は渡っている間が危ないのが値打ちで、
 * さっと登れてしまうと危なくない。12m の梯子で 9 秒ほどかかる。
 *
 * これは**均した速さ**。実際は型の波に合わせて速くなったり緩んだりする
 * (motion.ts の climbSurge)。
 */
export const LADDER_SPEED = 1.35
