...
import type { RoomSummary } from '../../src/application/protocol/types'
...
const ROOMS: RoomSummary[] = [
  ...
  { name: 'delta', mode: 'TDM', label: 'チーム戦', note: '砂部屋', active: true, players: 1, capacity: 8, phase: 'playing', roster: [], blue: 0, red: 0, remaining: 0 },
